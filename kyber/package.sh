...
unifdef -k -m -DKYBER_K=2 -DKYBER_ETA1=3 -DKYBER_ETA2=2 -DKYBER_POLYCOMPRESSEDBYTES=128 -DKYBER_SSBYTES=32 -DKYBER_INDCPA_MSGBYTES=32 -DXOF_BLOCKBYTES=168 -U__GNUC__ -U__clang__ -UKYBER_90S ${BUILD_CRYPTO_KEM}/ml-kem-512/*/*.{c,h,S}
unifdef -k -m -DKYBER_K=3 -DKYBER_ETA1=2 -DKYBER_ETA2=2 -DKYBER_POLYCOMPRESSEDBYTES=128 -DKYBER_SSBYTES=32 -DKYBER_INDCPA_MSGBYTES=32 -DXOF_BLOCKBYTES=168 -U__GNUC__ -U__clang__ -UKYBER_90S ${BUILD_CRYPTO_KEM}/ml-kem-768/*/*.{c,h,S}
unifdef -k -m -DKYBER_K=4 -DKYBER_ETA1=2 -DKYBER_ETA2=2 -DKYBER_POLYCOMPRESSEDBYTES=160 -DKYBER_SSBYTES=32 -DKYBER_INDCPA_MSGBYTES=32 -DXOF_BLOCKBYTES=168 -U__GNUC__ -U__clang__ -UKYBER_90S ${BUILD_CRYPTO_KEM}/ml-kem-1024/*/*.{c,h,S}
